...
const SearchResults = () => {
  ...
  const mockResults = {
    ...
    posts: [
      ...
      {
        id: 2,
        content: 'Great session on machine learning today. Thanks to all the participants!',
        author: 'Priya Sharma',
        authorAvatar: null,
        likes: 23,
        comments: 8,
    ...
    hashtags: [
      { name: '#PPSUFest2024', posts: 125, trending: true },
      { name: '#CampusLife', posts: 89, trending: false },
      { name: '#TechSymposium', posts: 45, trending: true },
      { name: '#StudyGroup', posts: 67, trending: false }
    ],
    events: [
      {
        id: 1,
